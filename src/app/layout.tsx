...
export const metadata: Metadata = {
  title: "LuxeDrive - Premium Luxury & Sports Cars",
  description: "Discover hand-selected luxury and performance vehicles. Premium automobiles from Ferrari, Porsche, Lamborghini, and more. Expert service and transparent pricing.",
  keywords: "luxury cars, sports cars, premium vehicles, supercar, Ferrari, Porsche, Lamborghini, Aston Martin, car dealership",
  ...
  openGraph: {
    title: "LuxeDrive - Premium Luxury & Sports Cars",
    description: "Discover hand-selected luxury and performance vehicles. Premium automobiles from Ferrari, Porsche, Lamborghini, and more.",
    url: "https://luxedrive.com",
    siteName: "LuxeDrive",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1766149525596-tynxoxil.jpg",
        alt: "Featured luxury cars"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1766149525596-tynxoxil.jpg"]
  },
  robots: {
    index: true,
    follow: true
